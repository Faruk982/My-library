...
public class History extends javax.swing.JFrame {
     ...
     */
    public String idd,eml;
    public History() {
        initComponents();
    }
     public History(String ee) {
        initComponents();
        this.idd=ee;this.eml=ee;
        searchBooks(ee);
    }
     public History(String ee,String em) {
        initComponents();
        this.idd=ee;
        this.eml=em;
        searchBooks(ee);
    ...
    private void initComponents() {
        ...
        resultTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "E-mail", "Name", "Author", "publisher", "Code", "Edition", "Taken", "Return", "Fine"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!idd.isEmpty()){
              Profile homeFrame = new Profile(idd);
                ...
                while (resultSet.next()) {
                    model.addRow(new Object[] {
                      ...
                      //  resultSet.getString("Code"),
                        ...
                        resultSet.getString("Returning_date"),
